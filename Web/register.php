...
<div class="login-wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first p-3">
        <div class="img-container" style="width: 150px; height: auto; margin: 0 auto">
            <img src="includes/images/login.png" id="icon" alt="User Icon" style="width: 100%; height: auto"/>
        </div>
    </div>
    ...
    <form action="register-submit.php" method="post">
        ...
        <input type="password" id="repassword"  name="confirmpassword" placeholder="RePassword" required>
        <input type="text" id="email"  name="email" placeholder="email" required>
        <input type="text" id="name"  name="fullname" placeholder="Fullname" required>
